% ------------------------------------------------------------------------------
% TYPO3 CMS 6.2 LTS - What's New - Test/Example Chapter (English Version)
%
...
% ------------------------------------------------------------------------------
% Example: Polish signs
% ------------------------------------------------------------------------------

\begin{frame}
	\frametitle{Test Chapter}
	\framesubtitle{Polish signs}
	
	All polish signs:
	A,a -> Ą,ą \textbf{bold: Ą,ą} \newline
	E,e -> Ę,ę \textbf{bold: Ę,ę} \newline
	O,o -> Ó,ó \textbf{bold: Ó,ó} \newline
	L,l -> Ł,ł \textbf{bold: Ł,ł} \newline
	S,s -> Ś,ś \textbf{bold: Ś,ś} \newline
	C,c -> Ć,ć \textbf{bold: Ć,ć} \newline
	Z,z -> Ż,ż (with dot) \textbf{bold: Ż,ż}\newline
	Z,z -> Ź,ź \textbf{bold: Ź,ź}
